...
public class Constants {
    ...
    private static AttachedButtons attachedButtons = new AttachedButtons();
    ...
    public final static Message UNK_COM = new Message("Извини, такую команду я не знаю. Напиши Список команд, чтобы увидеть полный список команд");
